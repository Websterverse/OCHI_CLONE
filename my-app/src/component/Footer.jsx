...
const Footer = () => {
    return (
        <div className='w-full min-h-screen px-20 flex  py-20 ' >

            <div className='first w-1/2 h-full    '  >

                <h1 className='text-8xl  font-semibold  tracking-tighter leading-none font-[Neue_Montreal] ' >EYE-</h1>
                <h1 className='text-8xl  font-semibold tracking-tighter leading-none font-[Neue_Montreal] '  >OPENING</h1>

                <div className='logo  pt-[80vh] ' >
      <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='first w-1/2 h-full    '  >
                ...
                <h1 className='text-8xl  font-semibold  tracking-tighter leading-none font-[Neue_Montreal] ' >PRESENTATIONS</h1>

                <div   >

                    <h1 className='pt-12 pb-4 '  >S:</h1>
                    <a className='underline ' href="">INSTAGRAM</a> <br />
                    <a className='underline ' href="">BEHANCE</a> <br />
                    <a className='underline ' href="">META</a> <br />
                ...
                <div className='flex justify-between items-center '  >
                    ...
                    <div>
                        <h1 className='pt-12 pb-4 '  >L:</h1>
                        <a className='underline ' href="">202-1965 W 4TH Ave</a> <br />
                        <a className='underline  ' href="">Vancouver , Canada</a> <br />
                        <a className=' pb-4 underline   ' href="">30 Chukarina St</a> <br />
                        <a className='underline ' href="">Lviv, Ukraine</a>
                    </div>

                    <div>
                        <h1 className='pt-4 pb-4 '  >M:</h1>
                        <a className='underline ' href="">HOME</a> <br />
                        <a className='underline  ' href="">SERVICE</a> <br />
                        <a className=' pb-4 underline   ' href="">OUR WORK </a> <br />
                ...
                <div>
                    ...
                    <h1 className='pt-16 pb-4 '  >E:</h1>
                    <a className='underline ' href="">hello@ochi.design</a> <br />


                </div>


<div className='flex justify-center items-center gap-80  pt-40  ' >

<h1>&copy; ochi design 2024. <span className='underline' >Legal Terms</span> </h1>
